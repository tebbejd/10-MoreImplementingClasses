...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        start = self.start
        end1 = other_line.end
        start1 = other_line.start
        new_line = Line(Point(start.x + start1.x, start.y + start1.y), Point(end.x + end1.x, end.y + end1.y))
        return new_line
    ...
    def midpoint(self):
        ...
        mid = Point((end.x + start.x) / 2, (end.y + start.y) / 2)
        return mid
